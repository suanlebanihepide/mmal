...
public class UserController {
    ...
    @ResponseBody
    public ServerResponse<String> resetPassword(HttpSession session,String pasword,String passwordNew){
        ...
        return iUserService.resetPassword(pasword,passwordNew,user);
    }
